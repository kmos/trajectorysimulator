...
if t > 1
    ...
    if t > 2
        ...
        %%XXX: inserito da giovanni - calcolo accelerazioni body con errore
        AxbErr = Axb(t) + AccErrXb(t);
        AybErr = Ayb(t) + AccErrYb(t);
        AzbErr = Azb(t) + AccErrZb(t);
        ...
        %XXX: inserito da giovanni - Calcolo accelerazioni NED con errore
        [AxNEDerr(t), AyNEDerr(t), AzNEDerr(t)] = Body2NED(AxbErr,AybErr,AzbErr,PhiErr(t), ThetaErr(t), PsiErr(t));
